    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <form  action="<?php echo site_url('home/payment'); ?>" method="post" id="frm_registration" name="frm_registration" class="">
                    ...
                    <input type="hidden" name="surl" value="<?php echo site_url('/home/payment_success'); ?>" />
                    <input type="hidden" name="furl" value="<?php echo site_url('/home/payment_failed'); ?>" />
